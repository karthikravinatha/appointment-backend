...
from APPOINTMENT_APP.repository.loginlog_repository import loginlogRepo
...
class LoginLogService(BaseService):
    ...
    def add_data(self, object):
        loginlog_repo: loginlogRepo = loginlogRepo(self.ext_params)
        return loginlog_repo.add_data(object)
    ...
    def update_data(self, object):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.update_data(object)
    ...
    def delete_data(self, object):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.delete_data(object)
    ...
    def get_data(self, params):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.get_data(params)
    ...
    def get_data_list(self, params):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        loginlog_repo: loginlogRepo = loginlogRepo()
        return loginlog_repo.get_data_list_object_any_paginated(sp_name, params)
