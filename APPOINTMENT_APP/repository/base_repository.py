...
from APPOINTMENT_APP.models.cursor_object import CursorObject
from APPOINTMENT_APP.utils.exception_handling.exception import DatabaseException, AppointmentException, FileUploadException
...
class BaseRepository:
    ...
    def add_data(self, object):
        ...
        try:
            ...
            if isinstance(ex, DatabaseException) or isinstance(ex, AppointmentException):
