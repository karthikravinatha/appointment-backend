...
class OCRHelper:
    ...
    # os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/var/www/html/KARO/KAROAPP/utils/constants/KARO-OCR-1.json'
    os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = os.path.join(settings.PROJECT_ROOT, 'KAROAPP', 'utils', 'constants', 'KARO-OCR-1.json')
